...
<table align="center" cellpadding="5" cellspacing="2" width="600" border='1'>
    ...
    <tr>
        ...
        <td width="450" height="20" colspan="3">
        	<span style="font-size:9pt;"><b>${noticeDTO.noticeNo}</b></span>
        </td>
    </tr>
    <tr>
        ...
        <td width="100" height="20">
			<p><b><span style="font-size:9pt;"></span>${noticeDTO.noticeDate}</b></p>
		</td>
    </tr>
    <tr>
        <td width="100" height="20">
        ...
        <td width="450" height="20" colspan="3">
        	<span style="font-size:9pt;"><b>${noticeDTO.noticeSubject}</b></span>
        </td>
    </tr>
    <tr>
        ...
        <span style="font-size:9pt;"><b><pre>${noticeDTO.noticeContent}</pre></b></span></td>
    </tr>
    ...
    <tr>
        <td height="20" colspan="4" align="center" valign="middle">
			<!-- 수정시 필요한 데이터들을 hidden으로 숨겨놓고 폼 데이터로 보내준다. -->
				<input type="text" name="noticeNo" value="${noticeDTO.noticeNo}">
				<input type="text" name="key" value=noticeBoard>
